...
public class GpuBwProvisionerSimple extends GpuBwProvisioner {
	 ...
	 * 
	 * @see
	 * cloudsim.gpu.provisioners.GpuBwProvisioner#allocateBwForVgpu
	 * (cloudsim.gpu.Vgpu, long)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cloudsim.gpu.provisioners.GpuBwProvisioner#isSuitableForVm
	 * (cloudsim.gpu.Vgpu, long)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cloudsim.gpu.provisioners.GpuBwProvisioner#getAvailableBw()
	 */
	@Override
