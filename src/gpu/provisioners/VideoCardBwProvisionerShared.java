...
public class VideoCardBwProvisionerShared extends VideoCardBwProvisioner {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see cloudsim.gpu.provisioners.VideoCardBwProvisioner#
	 * allocateBwForPgpu(cloudsim.gpu.Pgpu, long)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * cloudsim.gpu.provisioners.VideoCardBwProvisioner#getAvailableBw(
	 * )
	 */
	@Override
