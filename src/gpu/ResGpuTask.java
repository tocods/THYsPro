...
public class ResGpuTask {
	...
	public double lastMemoryTransferTime;
	...
	public TransferState state = TransferState.IN_HOST;
	...
	private void init() {
		...
		//Log.printLine("内核finishedSoFor: " + taskFinishedSoFar);
	}
	...
	public void updateTaskMemoryTransfer(double v) {
