...
public class JNIfncs {
    ...
    public static void main(String[] var0) {
        ...
        while(time < time_stop) {
            publish("object.attribute", "value_from_fncs");
            publish("this.will.be.dropped", "value_from_fncs");
            route("endpointX", "endpointY", "key", "value_from_fncs");
            String[] var8 = get_events();
            for(String s: var8)
                Log.printLine("get " + s + " with value " + get_value(s));
            time_desired = time + 1;
