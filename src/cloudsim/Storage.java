...
public interface Storage {
	 ...
	 * {@link cloudsim.File#getTransactionTime()}.
	 * 
	 ...
	 * file can also be found using {@link cloudsim.File#getTransactionTime()}.
	 * 
	 ...
	 * also be found using {@link cloudsim.File#getTransactionTime()}.
	 * 
	 * @param file the file to be added
	 ...
	 * can also be found using {@link cloudsim.File#getTransactionTime()}.
	 * 
