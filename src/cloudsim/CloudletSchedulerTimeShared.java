...
import faulttolerant.Parameters;
 ...
 */
public abstract class CloudletSchedulerTimeShared extends CloudletScheduler {
	...
	protected double getCapacity(List<Double> mipsShare) {
		double capacity = mipsShare.size() * mipsShare.get(0);
...
//		}
	...
	public abstract double cloudletSubmitWithoutGPU(Cloudlet cloudlet, double fileTransferTime);
