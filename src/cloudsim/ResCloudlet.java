...
public class ResCloudlet {
	...
	private void init() {
		...
		//Log.printLine("finishedSoFar: " + cloudletFinishedSoFar);
	}

	public void addLength(long length) {
		cloudletFinishedSoFar -= length * Consts.MILLION;
	}
	...
	public boolean setCloudletStatus(int status) {
		...
		try {
			...
			//Log.printLine(((GpuJob)cloudlet).getName() + ": " + prevStatus);
	 ...
	 * @post $none
         ...
         * At {@link  CloudletSchedulerTimeShared#cloudletSubmit(cloudsim.Cloudlet)}
